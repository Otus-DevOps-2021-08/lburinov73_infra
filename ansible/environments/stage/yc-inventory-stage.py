...
def cmd_list(sdk, folder_id):
    ...
    for instance in instances.instances:
        ...
        if instance.status != 2 or str(nat_ipv4) == "" or not instance.name.startswith("stage-"):
            continue
...
def main():
    ...
    with open("/home/leo/otus-devops/key.json") as keyfile:
        sdk = yandexcloud.SDK(
